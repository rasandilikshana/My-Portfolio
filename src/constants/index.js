...
const experiences = [
  {
    title: "Temporary Teller / Cashier",
  ...
  {
    title: "Trainee Web & Gis Developer",
    company_name: "Centre for Defence Research and Development",
    icon: cdrd,
    iconBg: "#E6DEDD",
  ...
  },
  {
    ...
    company_name: "Zuse Technologies",
    icon: zuse,
    iconBg: "#383E56",
